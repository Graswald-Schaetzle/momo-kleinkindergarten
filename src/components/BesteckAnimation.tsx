  ...
  return (
    ...
    >
      ...
      <img
        src={messer}
        alt=""
        className="besteck besteck-messer absolute left-1/2 top-1/2 w-[82%] -translate-x-1/2 -translate-y-1/2"
      />
      <img
        src={gabel}
        alt=""
        className="besteck besteck-gabel absolute left-1/2 top-1/2 w-[84%] -translate-x-1/2 -translate-y-1/2"
      />
    </div>
  );
}
