...
import paedagogikBlumen from "@/assets/grafik-18.png.asset.json";
    ...
    <>
      <section className="relative mx-auto max-w-2xl px-6 pt-8 sm:px-10 sm:pt-12 md:px-14">
        ...
        <img
          ...
          width={1024}
          height={1024}
          className="pointer-events-none mx-auto mt-4 w-48 select-none bg-altrosa sm:mt-6 sm:w-64 md:w-72"
        />
