...
function Pflege() {
  return (
    <>
      <section className="mx-auto max-w-xl px-6 pt-10 sm:px-10 sm:pt-8 md:px-14">
        <h1 className="font-display text-center text-2xl font-normal tracking-[0.08em] sm:text-xl">
          Pflege
        </h1>
      ...
      <section className="mx-auto max-w-xl px-6 pt-20 pb-24 sm:px-10 sm:pt-10 sm:pb-12 md:px-14">
        <div className="flex flex-nowrap items-center justify-center gap-x-8 sm:gap-x-8">
          {brands.map((b) => (
            <img
              key={b.alt}
              src={b.src}
