  ...
  return (
    <main className="flex flex-1 flex-col items-center pb-2 text-center">
      ...
      <div className="relative mx-auto flex flex-1 w-full max-w-5xl flex-col items-center justify-center py-2">
        ...
        <p className="mt-8 px-6 font-display text-xl font-medium uppercase leading-tight tracking-[0.15em] text-bordeaux sm:mt-12 md:mt-16 sm:text-3xl md:text-4xl">Eröffnung Januar 2027</p>
      </div>
